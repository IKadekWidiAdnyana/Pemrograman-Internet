                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.php" style="font-weight: 800;"><div class="logo"><img src="img/logo-ojv.png" width="100px" alt=""></div></a>
                        </div>
                        <div class="collapse navbar-collapse">

                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                    <a href="../lowongan-Pekerjaan-main/index.php" class="navbar-brand" style="color: black;">
                        HOME
                    </a>
                        <li class="dropdown">
