    ...
    <body>
        ...
        <div class="section section-header">
            <div class="parallax filter filter-color-black">
                <div class="image" style="background-image: url('img/gambar1.jpg')">
                </div>
                <div class="container">
                    <div class="content">
                        <form method="GET" action="lowongan_list.php">
                            <div class="title-area">
                                <p>Cari LPK Yang Anda Inginkan</p><br/>
                                <div class="row" style="">
                                    <div class="col-md-8">
                                        <input type="text" class="form-control input-lg" name="nama" placeholder="Cari LPK" />
                                    </div>
                                    <div class="col-md-4">
