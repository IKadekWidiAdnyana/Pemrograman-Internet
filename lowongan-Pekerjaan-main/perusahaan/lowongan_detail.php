                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#" style="font-weight: 800;">OJV</a>
                        </div>
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-left" style="margin-left: 56px;">
                                ...
                                <li>
                                    <a href="#" data-toggle="modal" data-target="#search">Cari LPK</a>
                                    <!-- Modal Search -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <a href="php/report_semua_pelamar.php?id=<?php echo $_GET['id'];?>" target="_blank" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-print"></i>Print Data Pendaftar</a>
                                        <h4 class="title">Detail LPK</h4>
                                        <p class="category">Detail LPK dari LPK yang dipilih</p>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Deskripsi LPK</h4>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        <table class="table">
                                            <tbody>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">Syarat pendaftaran dari LPK yang dipilih</p>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            <thead>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <form method="POST" action="php/lowongan_syarat_edit_proses.php">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                        <h4 class="modal-title" id="myModalLabel">Syarat Pendaftaran</h4>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <h4 class="title">Job Desc Pelatihan</h4>
                                        <p class="category"> Job Desc pelatihan dari LPK yang dipilih </p>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-striped">
                                            <thead>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <form method="POST" action="php/lowongan_jobdesc_edit_proses.php">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                        <h4 class="modal-title" id="myModalLabel">Syarat LPK</h4>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label>Job Desc Pelatihan </label>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright pull-right">
                            ...
                            </script>, Hak Cipta Dari<a href="https://www.instagram.com/ojv.official/"> OJV | Online Job Vacancies</a>
                        </div>
                    </div>
                </footer>
            </div>
