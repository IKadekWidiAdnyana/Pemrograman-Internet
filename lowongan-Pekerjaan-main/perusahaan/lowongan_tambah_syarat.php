        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#addButton").click(function () {
                    ...
                    newTextBoxDiv.after().html('<label style="margin-top: 12px;">Syarat Pendaftaran '+ counter + ' </label>' +
                        '<input type="text" class="form-control border-input" placeholder="Syarat Pendaftaran" name="syarat' + counter +
                        '" id="syarat' + counter + '">');
                                            ...
                                            <form method="GET" action="lowongan.php">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">Maukkan Nama LPK</h4>
                                                    </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Tambah Syarat Pendaftaran</h4>
                                        </div>
                                        <div class="content">
                                            <div class="row">                                      
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div id='TextBoxesGroup'>  
                                                            <div id="TextBoxDiv1">   
                                                                <label>Syarat Pendaftaran 1</label>
                                                                <input type="text" class="form-control border-input" name="syarat" id="syarat1" placeholder="Syarat Pendaftaran" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
