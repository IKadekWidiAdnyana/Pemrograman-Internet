        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#addButton").click(function () {
                    ...
                    newTextBoxDiv.after().html('<label style="margin-top: 12px;">Job Desc  '+ counter + ' </label>' +
                        '<input type="text" class="form-control border-input" placeholder="Job Desc " name="jobdesc' + counter +
                        '" id="jobdesc' + counter + '">');
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Detail Job Desc Pelatihan</h4>
                                        </div>
                                        <div class="content">
                                            <div class="row">                                      
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div id='TextBoxesGroup'>  
                                                            <div id="TextBoxDiv1">   
                                                                ...
                                                                <input type="text" class="form-control border-input" name="jobdesc" id="jobdesc1" placeholder="Pelatihan" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
