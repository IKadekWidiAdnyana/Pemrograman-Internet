                                            ...
                                            <form method="GET" action="lowongan.php">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">Masukkan Judul LPK</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Judul LPK</label>
                                                            <input type="text" class="form-control border-input" name="nama" placeholder="Masukkan Nama LPK" />
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="content">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Judul LPK</label>
                                                        <input type="text" class="form-control border-input" name="judul" placeholder="Masukan Nama LPK" />
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
